                    ...
                    new Sequence(
                        ...
                        new Wait( 
                            ...
                            new Action( r => {
                                if ( Me.IsGhost )
                                {
                                    Logging.Write("Insignia taken or corpse release by something other than Singular...");
                        ...
                        new Action(r => Logging.Write("Ressurrecting Singular by invoking {0}...", SelfRezSpell)),
