        ...
        public static bool CallPet(string petName)
        {
            ...
            switch (StyxWoW.Me.Class)
            {
                case WoWClass.Warlock:
                    ...
                    {
                        Logging.Write(string.Format("[Pet] Calling out my {0}", petName));
                ...
                case WoWClass.Mage:
                    ...
                    {
                        Logging.Write("[Pet] Calling out Water Elemental");
                ...
                case WoWClass.Hunter:
                    if (SpellManager.CanCast("Call Pet " + petName))
                    {
                        if (!StyxWoW.Me.GotAlivePet)
                        {
                            Logging.Write(string.Format("[Pet] Calling out pet #{0}", petName));
