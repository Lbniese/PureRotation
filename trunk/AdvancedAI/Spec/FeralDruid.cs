...
//pool_resource,wait=0.25,if=combo_points>=5&((energy<50&buff.berserk.down)|(energy<25&buff.berserk.remains>1))&dot.rip.remains>=6.5
        ...
        Spell.Cast("Rake", ret => Me.CurrentTarget.GetAuraTimeLeft("Rake", true).TotalSeconds <= 3),
//pool_resource,wait=0.25,for_next=1
        ...
        Spell.Cast("Mangle", ret => Me.ComboPoints <= 5 && Me.CurrentTarget.GetAuraTimeLeft("Rip", true).TotalSeconds <= 3 || Me.ComboPoints == 0 && Me.HasAuraExpired("Savage Roar", 2)),
